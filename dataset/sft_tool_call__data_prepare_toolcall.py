...
def main():
    ...
    parser.add_argument('--source', type=str, default='hermes', choices=list(SOURCES.keys()),
                        help="数据源（hermes/glaive/xlam）")##glaive##===================================
    parser.add_argument('--max_length', type=int, default=512,
                        help="最大token长度，超过则跳过")
    parser.add_argument('--max_samples', type=int, default=10000,##10000##===================================
                        help="每个数据源最大样本数")
...
# python scripts/sft_tool_call__data_prepare_toolcall.py --source glaive --max_samples 10000
#
# # 训练（基于 SFT 权重继续训练）
